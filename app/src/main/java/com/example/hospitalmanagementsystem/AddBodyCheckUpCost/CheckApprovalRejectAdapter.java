...
public class CheckApprovalRejectAdapter extends RecyclerView.Adapter<CheckApprovalRejectAdapter.ViewHolder>{
ArrayList<CheckupModelClass> checkupModelClassArrayList;
Context context;

    public CheckApprovalRejectAdapter(ArrayList<CheckupModelClass> checkupModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkapprovalrejectonly_items,parent,false);
