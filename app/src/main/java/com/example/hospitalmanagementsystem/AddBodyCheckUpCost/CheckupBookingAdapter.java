...
import com.example.hospitalmanagementsystem.HomeDeliveryMedicine.BookingPageOrganActivity;
import com.example.hospitalmanagementsystem.R;

import java.util.ArrayList;

public class CheckupBookingAdapter extends RecyclerView.Adapter<CheckupBookingAdapter.ViewHolder>{
ArrayList<CheckupModelClass> checkupModelClassArrayList;
Context context;

    public CheckupBookingAdapter(ArrayList<CheckupModelClass> checkupModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkupbookibg_items,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bookingImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context,BookingPageOrganActivity.class);
                ...
                intent.putExtra("discounts",checkupModelClass.getDiscount());
