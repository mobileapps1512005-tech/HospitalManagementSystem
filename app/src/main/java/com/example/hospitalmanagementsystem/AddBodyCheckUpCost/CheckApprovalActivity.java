...
public class CheckApprovalActivity extends AppCompatActivity {
    ...
    CheckApprovalDataBase checkApprovalDataBase;
    int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_approval);
        ...
        checkApprovalDataBase = new CheckApprovalDataBase(getApplicationContext());
        ...
        discounts = getIntent().getStringExtra("discount");
        edPhone.setText(getIntent().getStringExtra("phone"));


        SelectDiscount();

        spinDiscount.setEnabled(false);
        edName.setEnabled(false);
        edPart.setEnabled(false);
    ...
    public void InsertDataCheckup(){
        ...
        boolean b = checkApprovalDataBase.InsertData(name,part,price,discounts,phone);
        if (b==true){
            edName.setText("");
            edPart.setText("");
            edPrice.setText("");
            ...
            checkUpBookingDataBase.GetDeleteCheckDelete(id);
        }else {
