...
public class CheckApprovalRejectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_check_approval_reject);
        ...
        checkRejectDataBase = new CheckRejectDataBase(getApplicationContext());
    ...
    public void InsertDataCheckup(){
        ...
        boolean b = checkRejectDataBase.InsertData(name,part,price,discounts,phone);
        if (b==true){
            edName.setText("");
            edPart.setText("");
            edPrice.setText("");
            ...
            Toast.makeText(getApplicationContext(), "Approval Reject SuccessFully....", Toast.LENGTH_SHORT).show();
