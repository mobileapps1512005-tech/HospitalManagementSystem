...
public class CheckPendingAdapter extends RecyclerView.Adapter<CheckPendingAdapter.ViewHolder>{
ArrayList<CheckupModelClass> checkupModelClassArrayList;
Context context;

    public CheckPendingAdapter(ArrayList<CheckupModelClass> checkupModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkpendingitems,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.btmConfirm.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                builder.setIcon(R.drawable.bodysspreview);
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(context, CheckApprovalActivity.class);
                        intent.putExtra("id",checkupModelClass.getId());
                        intent.putExtra("name",checkupModelClass.getName());
                        intent.putExtra("part",checkupModelClass.getPart());
                        intent.putExtra("price",checkupModelClass.getPrice());
                        intent.putExtra("discount",checkupModelClass.getDiscount());
                        intent.putExtra("phone",checkupModelClass.getPhone());
        ...
        holder.btnCancel.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder builder = new AlertDialog.Builder(context);
                builder.setTitle("ApprovalReject Confirmation...");
                builder.setMessage("Are You Sure You Want To ApprovalReject Confirmation...");
                builder.setCancelable(false);
                builder.setIcon(R.drawable.bodysspreview);
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(context, CheckApprovalRejectActivity.class);
                        intent.putExtra("id",checkupModelClass.getId());
                        intent.putExtra("name",checkupModelClass.getName());
                        intent.putExtra("part",checkupModelClass.getPart());
                        intent.putExtra("price",checkupModelClass.getPrice());
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            btmConfirm = itemView.findViewById(R.id.btnConfirm);
