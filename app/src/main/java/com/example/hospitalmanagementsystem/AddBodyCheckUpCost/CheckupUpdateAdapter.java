...
public class CheckupUpdateAdapter extends RecyclerView.Adapter<CheckupUpdateAdapter.ViewHolder>{
ArrayList<CheckupModelClass> checkupModelClassArrayList;
Context context;

    public CheckupUpdateAdapter(ArrayList<CheckupModelClass> checkupModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.checkbodyupdate_items,parent,false);
