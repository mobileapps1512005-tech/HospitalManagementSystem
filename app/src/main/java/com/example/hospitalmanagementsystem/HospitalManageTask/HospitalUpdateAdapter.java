...
public class HospitalUpdateAdapter extends RecyclerView.Adapter<HospitalUpdateAdapter.ViewHolder>{
    ArrayList<HospitalModelClass> hospitalModelClassArrayList;
    Context context;

    public HospitalUpdateAdapter(ArrayList<HospitalModelClass> hospitalModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.updatehospital_items,parent,false);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        Intent intent = new Intent(context, HospitalDetailsUpdateActivity.class);
                        intent.putExtra("id",hospitalModelClass.getId());
                        intent.putExtra("name",hospitalModelClass.getName());
                        intent.putExtra("year",hospitalModelClass.getYear());
                        intent.putExtra("email",hospitalModelClass.getEmail());
                        intent.putExtra("location",hospitalModelClass.getLocation());
                        intent.putExtra("phone",hospitalModelClass.getPhone());
