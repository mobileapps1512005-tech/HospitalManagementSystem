...
public class UpdateBillingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinTypeBill = findViewById(R.id.spinTypeBill);
        ...
        typeBill = getIntent().getStringExtra("bill");
    ...
    public void BillingInsertData(){
        ...
        if (hospital.isEmpty()){
            ...
            Toast.makeText(getApplicationContext(), "Please Select Valid Billing Option", Toast.LENGTH_SHORT).show();
            return;
        } if (discount.equals("Please Select Discount")){
            Toast.makeText(getApplicationContext(), "Please Select Valid Discount Option", Toast.LENGTH_SHORT).show();
            return;
        ...
        boolean b = patientBillingDataBase.UpdateBillingData(id,hospital,name,email,phone,cost,discount,typeBill,date,time);
        if (b==true){
            edHospital.setText("");
            edName.setText("");
            edEmail.setText("");
...
// More billing types
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(getApplicationContext(), android.R.layout.simple_list_item_1,selectTypeBill);
        arrayAdapter.setDropDownViewResource(android.R.layout.select_dialog_singlechoice);
        spinTypeBill.setAdapter(arrayAdapter);

        if (selectTypeBill!=null) {
            int position = arrayAdapter.getPosition(typeBill.toString());
            if (position > 0) {
                spinTypeBill.setSelection(position);
            }
        }
    }
    ...
    public void selectDiscountType(){
        ...
        ArrayAdapter<String> arrayAdapter =new ArrayAdapter<>(getApplicationContext(),android.R.layout.simple_list_item_1,selectDiscount);
        arrayAdapter.setDropDownViewResource(android.R.layout.select_dialog_singlechoice);
    ...
    public void SelectDate(){
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(UpdateBillingActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
    ...
    public void SelectTime(){
        ...
        TimePickerDialog timePickerDialog = new TimePickerDialog(UpdateBillingActivity.this, new TimePickerDialog.OnTimeSetListener() {
            @Override
