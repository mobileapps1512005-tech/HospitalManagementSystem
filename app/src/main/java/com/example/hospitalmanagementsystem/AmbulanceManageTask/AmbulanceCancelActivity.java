...
public class AmbulanceCancelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ambulance_cancel);
        ...
        ambulanceCancelDataBase = new AmbulanceCancelDataBase(getApplication());
    ...
    public void InsertData(){
        ...
        boolean b = ambulanceCancelDataBase.InsertDataCancel(name,email,phone,alterNumber,location,ambulances);
        if (b==true){
            EdName.setText("");
            EdEmail.setText("");
            EdPhone.setText("");
