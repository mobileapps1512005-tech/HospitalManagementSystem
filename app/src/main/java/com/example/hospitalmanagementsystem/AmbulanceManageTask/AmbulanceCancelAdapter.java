...
public class AmbulanceCancelAdapter extends RecyclerView.Adapter<AmbulanceCancelAdapter.ViewHolder>{
ArrayList<AmbulanceBookingModelClass> ambulanceBookingModelClassArrayList;
Context context;

    public AmbulanceCancelAdapter(ArrayList<AmbulanceBookingModelClass> ambulanceBookingModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ambulancecancel_items,parent,false);
