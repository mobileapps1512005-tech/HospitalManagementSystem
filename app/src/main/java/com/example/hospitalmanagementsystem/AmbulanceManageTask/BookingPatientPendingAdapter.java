...
public class BookingPatientPendingAdapter extends RecyclerView.Adapter<BookingPatientPendingAdapter.ViewHolder>{
ArrayList<AmbulanceBookingModelClass> ambulanceBookingModelClassArrayList;
Context context;

    public BookingPatientPendingAdapter(ArrayList<AmbulanceBookingModelClass> ambulanceBookingModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ambulancebook_items,parent,false);
