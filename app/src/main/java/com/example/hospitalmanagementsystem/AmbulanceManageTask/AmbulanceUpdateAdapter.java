...
public class AmbulanceUpdateAdapter extends RecyclerView.Adapter<AmbulanceUpdateAdapter.ViewHolder>{
ArrayList<AmbulanceModelClass> ambulanceModelClassArrayList;
Context context;

    public AmbulanceUpdateAdapter(ArrayList<AmbulanceModelClass> ambulanceModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ambulanceupdate_items,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
       ...
       holder.updateImg.setOnClickListener(new View.OnClickListener() {
           @Override
           public void onClick(View v) {
               Intent intent = new Intent(context,AmbulanceUpdateActivity.class);
               intent.putExtra("id",ambulanceModelClass.getId());
               intent.putExtra("name",ambulanceModelClass.getName());
               intent.putExtra("email",ambulanceModelClass.getEmail());
               intent.putExtra("experience",ambulanceModelClass.getExperience());
               intent.putExtra("license",ambulanceModelClass.getLicense());
               intent.putExtra("driver",ambulanceModelClass.getDriverContact());
               intent.putExtra("vehicle",ambulanceModelClass.getVehicleNo());
               intent.putExtra("hospitalName",ambulanceModelClass.getHospitalName());
               intent.putExtra("hospital",ambulanceModelClass.getHospitalNo());
               intent.putExtra("baseFare",ambulanceModelClass.getBaseFare());
               intent.putExtra("perKm",ambulanceModelClass.getPerKmCost());
               intent.putExtra("emergency",ambulanceModelClass.getEmergencyCost());
               intent.putExtra("doctor",ambulanceModelClass.getWithDoctor());
               intent.putExtra("withOutDoctor",ambulanceModelClass.getWithoutDoctor());
               intent.putExtra("ac",ambulanceModelClass.getWithAC());
               intent.putExtra("withOutAc",ambulanceModelClass.getWithoutAC());
               intent.putExtra("All",ambulanceModelClass.getAmbulanceAllPackage());
