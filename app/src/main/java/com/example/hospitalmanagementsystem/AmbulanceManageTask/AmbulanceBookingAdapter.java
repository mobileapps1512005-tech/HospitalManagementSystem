...
public class AmbulanceBookingAdapter extends RecyclerView.Adapter<AmbulanceBookingAdapter.ViewHolder>{
ArrayList<AmbulanceModelClass> ambulanceModelClassArrayList;
Context context ;
    public AmbulanceBookingAdapter(ArrayList<AmbulanceModelClass> ambulanceModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.ambulancebooking_items,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.bookingImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, AmbulanceBookingForPatientActivity.class);
