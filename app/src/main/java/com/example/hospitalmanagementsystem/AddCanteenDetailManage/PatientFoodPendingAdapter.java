...
public class PatientFoodPendingAdapter extends RecyclerView.Adapter<PatientFoodPendingAdapter.ViewHolder>{
ArrayList<PatientFoodRequestModelClass> patientFoodRequestModelClassArrayList;
Context context;
    public PatientFoodPendingAdapter(ArrayList<PatientFoodRequestModelClass> patientFoodRequestModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.canteenfoodspending_items,parent,false);
