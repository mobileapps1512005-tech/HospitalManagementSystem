...
public class MenuStockAdapter extends RecyclerView.Adapter<MenuStockAdapter.ViewHolder>{
ArrayList<CanteenModelClass> canteenModelClassArrayList;
Context context;

    public MenuStockAdapter(ArrayList<CanteenModelClass> canteenModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.canteenstockmenu_items,parent,false);
