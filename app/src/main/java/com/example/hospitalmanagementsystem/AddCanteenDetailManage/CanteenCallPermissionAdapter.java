...
public class CanteenCallPermissionAdapter extends RecyclerView.Adapter<CanteenCallPermissionAdapter.ViewHolder>{
ArrayList<CanteenModelClass> canteenModelClassArrayList;
Context context;

    public CanteenCallPermissionAdapter(ArrayList<CanteenModelClass> canteenModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.canteencallpermission_items,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.aSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            ...
            editor.putBoolean(uniqueKey,isChecked);
            editor.apply();
            if (isChecked){
                holder.status.setText("Call Permission Allow");
                holder.status.setTextColor(Color.GREEN);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        TextView menu,half,halfPrice,fullPlate,fullPrice,discount,combo,phone,status;
