...
public class PatientBookingOrderMenuItemsActivity extends AppCompatActivity {
...
int id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_patient_booking_order_menu_items);
    ...
    public void InsertBookingData(){
     ...
     boolean b = foodOrderPatientDataBase.InsertBookingData(name,menuItem,quantity,floor,bed,phone);
        if (b==true){
