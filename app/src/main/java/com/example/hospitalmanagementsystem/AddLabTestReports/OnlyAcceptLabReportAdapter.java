...
public class OnlyAcceptLabReportAdapter extends RecyclerView.Adapter<OnlyAcceptLabReportAdapter.ViewHolder>{
ArrayList<LabModelClass> modelClassArrayList;
Context context;
    public OnlyAcceptLabReportAdapter(ArrayList<LabModelClass> modelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.onlylabreportaccept_items,parent,false);
