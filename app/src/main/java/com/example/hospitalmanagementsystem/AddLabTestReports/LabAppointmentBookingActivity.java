...
public class LabAppointmentBookingActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lab_appointment_booking);
        ...
        ladReportsDataBase = new LadReportsDataBase(getApplicationContext());
    ...
    public void InsertLabData(){
        ...
        boolean b = labReportBookingDataBase.InsertLadData(name,part,cost,phone);
        if (b==true){
            edName.setText("");
            edPart.setText("");
            edCost.setText("");
