...
public class PatientLabReportPendingAdapter extends RecyclerView.Adapter<PatientLabReportPendingAdapter.ViewHolder>{
ArrayList<LabModelClass> modelClassArrayList;
Context context;

    public PatientLabReportPendingAdapter(ArrayList<LabModelClass> modelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.labreporpendingonly_items,parent,false);
