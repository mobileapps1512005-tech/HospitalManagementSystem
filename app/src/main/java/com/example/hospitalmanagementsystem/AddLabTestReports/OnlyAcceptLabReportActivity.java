...
public class OnlyAcceptLabReportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_only_accept_lab_report);
       ...
       labReportBookingDataBase = new LabReportBookingDataBase(getApplicationContext());
        ownerLabReportAcceptDataBase = new OwnerLabReportAcceptDataBase(getApplicationContext());
    ...
    public void InsertLabData(){
        ...
        boolean b = ownerLabReportAcceptDataBase.OwnerInsertLabData(name,part,cost,phone);
        if (b==true){
            edName.setText("");
            edPart.setText("");
            edCost.setText("");
