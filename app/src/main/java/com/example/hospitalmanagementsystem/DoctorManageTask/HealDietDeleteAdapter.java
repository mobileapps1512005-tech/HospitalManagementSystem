...
public class HealDietDeleteAdapter extends RecyclerView.Adapter<HealDietDeleteAdapter.ViewHolder>{
ArrayList<HealDietModelClass> healDietModelClassArrayList;
Context context;
HealDietDataBase healDietDataBase;

    public HealDietDeleteAdapter(ArrayList<HealDietModelClass> healDietModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.healdietdelete_items,parent,false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull ViewHolder holder,@SuppressLint("RecyclerView") int position) {
        healDietDataBase = new HealDietDataBase(context);
            ...
            public void onClick(View v) {
                ...
                builder.setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                      healDietDataBase.GetDeleteHealDiet(healDietModelClass.getId());
                      healDietModelClassArrayList.remove(position);
                      notifyItemRemoved(position);
                      notifyItemRangeRemoved(position,healDietModelClassArrayList.size());
