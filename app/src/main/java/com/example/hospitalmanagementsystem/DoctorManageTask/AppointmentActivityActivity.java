...
public class AppointmentActivityActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doctorAppointmentDataBase = new DoctorAppointmentDataBase(getApplication());
...
// 🔹 All 4-Day Combinations (Total 35)
    ...
    public void InsertDoctorData(){
        ...
        boolean b = doctorAppointmentDataBase.InsertAppointmentData(name,email,AvailableDay,AvailableTime,phone);
        if (b==true){
            Toast.makeText(getApplication(), "Insert SuccessFully...", Toast.LENGTH_SHORT).show();
            EdName.setText("");
            EdEmail.setText("");
            EdPhone.setText("");
            ...
            Toast.makeText(getApplication(), "Insert Data Failed...", Toast.LENGTH_SHORT).show();
        }
    }
