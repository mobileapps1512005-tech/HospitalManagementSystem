...
public class PatientCheckAppointmentAdapter extends RecyclerView.Adapter<PatientCheckAppointmentAdapter.ViewHolder>{
ArrayList<PatientModelClassAppointment> patientModelClassAppointmentArrayList;
Context context;

    public PatientCheckAppointmentAdapter(ArrayList<PatientModelClassAppointment> patientModelClassAppointmentArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.patientappointmentstatus_items,parent,false);
