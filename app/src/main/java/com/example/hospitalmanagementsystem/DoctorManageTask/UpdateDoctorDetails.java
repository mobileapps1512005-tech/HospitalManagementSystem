...
public class UpdateDoctorDetails extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_doctor_details);
        ...
        YearExperiences = getIntent().getStringExtra("experience");
        Specialist = getIntent().getStringExtra("specialist");
        AvailableDay = getIntent().getStringExtra("availableDay");
    ...
    public void SelectQualification(){
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(getApplication(), android.R.layout.simple_list_item_1,quals);
    ...
    public void SelectSpecial(){
        ...
        ArrayAdapter<String> arrayAdapterSpecial = new ArrayAdapter<>(getApplication(), android.R.layout.simple_list_item_1,SelectSpecial);
        ...
        if (SelectSpecial != null) {
            int position = arrayAdapterSpecial.getPosition(Specialist.trim());
            if (position >= 0) {
                SpinSpecial.setSelection(position);
            }
        }
    ...
    public void SelectDoctorExperience(){
        ...
        if (YearExperiences != null) {
            int position = arrayAdapter.getPosition(YearExperiences.trim());
            if (position >= 0) {
...
// 🔹 All 4-Day Combinations (Total 35)
    ...
    public void InsertDoctorData(){
        ...
        boolean b = doctorDataBase.UpdateDoctorDetails(Id,name,email,Qualification,YearExperiences,Specialist,AvailableDay,AvailableTime,phone);
        if (b==true){
