...
public class CancelAppointmentAdapter extends RecyclerView.Adapter<CancelAppointmentAdapter.ViewHolder>{
    ...
    public CancelAppointmentAdapter(ArrayList<PatientModelClassAppointment> patientModelClassAppointmentArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.appointmentcancal_item_only,parent,false);
