...
public class DrCancelAppointmentActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dr_cancel_appointment);
        ...
        drCancelAppointmentDataBase = new DrCancelAppointmentDataBase(getApplicationContext());
...
// 🔹 All 4-Day Combinations (Total 35)
    ...
    public void InsertDoctorData(){
        ...
        boolean b = drCancelAppointmentDataBase.InsertDrCancelAppointmentData(name,email,AvailableDay,AvailableTime,phone);
        if (b==true){
            Toast.makeText(getApplication(), "Cancel SuccessFully...", Toast.LENGTH_SHORT).show();
            EdName.setText("");
            EdEmail.setText("");
            EdPhone.setText("");
            ...
            Toast.makeText(getApplication(), "Cancel Failed...", Toast.LENGTH_SHORT).show();
        }
    }
