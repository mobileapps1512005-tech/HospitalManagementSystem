...
public class ConfirmAppointmentAdapterDr extends RecyclerView.Adapter<ConfirmAppointmentAdapterDr.ViewHolder>{
ArrayList<PatientModelClassAppointment> patientModelClassAppointmentArrayList;
Context context;

    public ConfirmAppointmentAdapterDr(ArrayList<PatientModelClassAppointment> patientModelClassAppointmentArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.confirmappointment_items_only,parent,false);
