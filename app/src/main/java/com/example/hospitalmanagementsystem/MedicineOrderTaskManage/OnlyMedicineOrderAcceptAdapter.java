...
public class OnlyMedicineOrderAcceptAdapter extends RecyclerView.Adapter<OnlyMedicineOrderAcceptAdapter.ViewHolder>{
ArrayList<MedicineModelClass> medicineModelClassArrayList;
Context context;

    public OnlyMedicineOrderAcceptAdapter(ArrayList<MedicineModelClass> medicineModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.onlyacceptrequestmedicine_items,parent,false);
