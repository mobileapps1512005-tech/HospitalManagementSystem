...
public class MedicineUpdateAdapter extends RecyclerView.Adapter<MedicineUpdateAdapter.ViewHolder>{
ArrayList<MedicineModelClass> medicineModelClassArrayList;
Context context;

    public MedicineUpdateAdapter(ArrayList<MedicineModelClass> medicineModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.medicineupdate_item,parent,false);
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.updateImg.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(context, MedicineUpdateActivity.class);
                ...
                intent.putExtra("delivery",modelClass.getDeliveryLocation());
                intent.putExtra("medicine",modelClass.getMedicineName());
