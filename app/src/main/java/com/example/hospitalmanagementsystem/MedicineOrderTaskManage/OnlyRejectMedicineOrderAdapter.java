...
public class OnlyRejectMedicineOrderAdapter extends RecyclerView.Adapter<OnlyRejectMedicineOrderAdapter.ViewHolder>{
ArrayList<MedicineModelClass> medicineModelClassArrayList;
Context context;
    public OnlyRejectMedicineOrderAdapter(ArrayList<MedicineModelClass> medicineModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.onlyrejectmedicineorder_itemss,parent,false);
