...
public class MedicineUpdateActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edDeliveryLocation.setText(getIntent().getStringExtra("delivery"));
        etMedicineName.setText(getIntent().getStringExtra("medicine"));
    ...
    public void InsertMedicineDetails() {
        ...
        boolean b = patientMedicineOrderDataBase.UpdateMedicineDetails(id,name,email,Phone,Location,deliveryLocation,medicineName,order,requiredDate,requiredTime);
        if (b==true){
    ...
    public void SelectOrderDate() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(MedicineUpdateActivity.this, new DatePickerDialog.OnDateSetListener() {
            @Override
