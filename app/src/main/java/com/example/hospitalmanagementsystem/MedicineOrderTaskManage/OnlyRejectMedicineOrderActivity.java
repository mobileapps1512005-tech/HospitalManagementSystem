...
public class OnlyRejectMedicineOrderActivity extends AppCompatActivity {
   ...
   OnlyRejectMedicineOrderDataBase onlyRejectMedicineOrderDataBase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_only_rejectmedicine_order);
        ...
        onlyRejectMedicineOrderDataBase = new OnlyRejectMedicineOrderDataBase(getApplicationContext());
    ...
    public void InsertMedicineDetails() {
        ...
        boolean b = onlyRejectMedicineOrderDataBase.RejectInsertMedicineDetails(name, email, Phone, Location, deliveryLocation, medicineName, order, requiredDate, requiredTime);
        if (b == true) {
