...
public class MedicineReturnRejectActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_medicine_return_reject);
        ...
        medicineReturnRejectDataBase = new MedicineReturnRejectDataBase(getApplicationContext());
    ...
    public void InsertAddPolicyData(){
        ...
        boolean b = medicineReturnRejectDataBase.InsertDataMedicineReject(name,condition,phone);
        if (b==true){
