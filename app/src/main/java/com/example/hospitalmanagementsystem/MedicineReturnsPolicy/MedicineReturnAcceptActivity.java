...
public class MedicineReturnAcceptActivity extends AppCompatActivity {
    EditText edName,edPhone;
    Spinner spinCondition;
    Button btnSubmit;
    String name,condition,phone;
    PatientReturnMedicineDataBase patientReturnMedicineDataBase;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mdicine_return_accept);

        edName = findViewById(R.id.edName);
        edPhone = findViewById(R.id.edPhone);
        spinCondition = findViewById(R.id.spinCondition);
        btnSubmit = findViewById(R.id.btnSubmit);
        patientReturnMedicineDataBase = new PatientReturnMedicineDataBase(getApplicationContext());
        medicineReturnAcceptDataBase = new MedicineReturnAcceptDataBase(getApplicationContext());
        ...
        spinCondition.setEnabled(false);
    ...
    public void InsertAddPolicyData(){
        ...
        boolean b = medicineReturnAcceptDataBase.InsertDataMedicineAccept(name,condition,phone);
        if (b==true){
            Toast.makeText(getApplicationContext(), "Approval SuccessFully...", Toast.LENGTH_SHORT).show();
            edName.setText("");
            spinCondition.setSelection(0);
            edPhone.setText("");
            patientReturnMedicineDataBase.GetAllDetailss(id);
        }else {
