...
public class MedicineReturnPendingOnlyAdapter extends RecyclerView.Adapter<MedicineReturnPendingOnlyAdapter.ViewHolder>{
ArrayList<MedicineReturnModelClass> medicineReturnModelClassArrayList;
Context context;

    public MedicineReturnPendingOnlyAdapter(ArrayList<MedicineReturnModelClass> medicineReturnModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.medicinereturnpendingonly_items,parent,false);
