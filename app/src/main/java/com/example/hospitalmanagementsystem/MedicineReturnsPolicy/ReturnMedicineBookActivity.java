...
public class ReturnMedicineBookActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_retun_medicine_book);
    ...
    public void InsertAddPolicyData(){
        ...
        boolean b = patientReturnMedicineDataBase.InsertMedicineData(name,condition,phone);
        if (b==true){
