...
public class MedicineReturnOnlyAcceptAdapter extends RecyclerView.Adapter<MedicineReturnOnlyAcceptAdapter.ViewHolder>{
ArrayList<MedicineReturnModelClass> medicineReturnModelClassArrayList;
Context context;

    public MedicineReturnOnlyAcceptAdapter(ArrayList<MedicineReturnModelClass> medicineReturnModelClassArrayList, Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.medicinereturnonlyaccept_items,parent,false);
